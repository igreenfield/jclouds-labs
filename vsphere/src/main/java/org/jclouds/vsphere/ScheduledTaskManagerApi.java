...
public interface ScheduledTaskManagerApi {
    ...
    public List<ScheduledTask> retrieveEntityScheduledTask(ManagedEntity entity) throws RuntimeFault, RemoteException;

    /** @since SDK4.0 */
    public List<ScheduledTask> retrieveObjectScheduledTask(ManagedObject obj) throws RuntimeFault, RemoteException;
}
